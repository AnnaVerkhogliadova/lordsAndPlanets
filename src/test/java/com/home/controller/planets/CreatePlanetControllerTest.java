...
public class CreatePlanetControllerTest {
    @Autowired
    private MockMvc mvc;
    ...
    public void createPlanet() throws Exception {
        ...
        PlanetRequest request = new PlanetRequest("anna");
    ...
    @Test
    public void createPlanetNegative() throws  Exception{
        String uri = "/v1/planets";
        PlanetRequest request = new PlanetRequest(null);
        MvcResult mvcResult = mvc.perform(MockMvcRequestBuilders.post(uri)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonString.asJsonString(request))
                .accept(MediaType.APPLICATION_JSON)).andReturn();
